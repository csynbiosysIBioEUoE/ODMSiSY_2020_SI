function [ res ] = M1_compute_Nullclines(theta, InitialStates_AU, initial_u)
% ToggleSwitch_M1_Compute_SteadyState computes the analytical steady state of the MToggleSwitch model 1 for the given values of

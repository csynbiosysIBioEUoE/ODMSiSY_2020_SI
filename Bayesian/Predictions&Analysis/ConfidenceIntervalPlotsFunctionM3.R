...
# ODE_Model3_Function.stan is a stan function file necessary to simulate the model for each experimental profile
# This script only works for Model 3. 

ConfidenceInterval3 <- function(experiment, aditInfo = "", stanRes){
  
  expose_stan_functions("ODE_Model3_Function.stan")
  ...
  write.table(resPlotR, file = paste("Model3_ODEs_ConfInter_Params", stanRes, "_Exper",experiment,"_RFP.csv", sep = ""), col.names = TRUE, sep = ",")
  write.table(resPlotG, file = paste("Model3_ODEs_ConfInter_Params", stanRes, "_Exper",experiment,"_GFP.csv", sep = ""), col.names = TRUE, sep = ",")

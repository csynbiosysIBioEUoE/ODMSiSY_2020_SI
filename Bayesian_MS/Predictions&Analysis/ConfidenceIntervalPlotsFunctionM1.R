...
# ODE_Model1_Function.stan is a stan function file necessary to simulate the model for each experimental profile
# This script only works for Model 1. 

ConfidenceInterval3 <- function(experiment, aditInfo = "", stanRes){
  
  expose_stan_functions("ODE_Model1_Function.stan")
  ...
  write.table(resPlotR, file = paste("Model1_ODEs_ConfInter_Params", stanRes, "_Exper",experiment,"_RFP.csv", sep = ""), col.names = TRUE, sep = ",")
  write.table(resPlotG, file = paste("Model1_ODEs_ConfInter_Params", stanRes, "_Exper",experiment,"_GFP.csv", sep = ""), col.names = TRUE, sep = ",")
  ...
  png(paste("CI_Mm_GFP_Model1_", fileName, "_Fit", aditInfo,".png", sep=""), width = 6, height = 4, units = 'in', res = 300)
  ...
  png(paste("CI_Mm_RFP_Model1_", fileName, "_Fit", aditInfo,".png", sep=""), width = 6, height = 4, units = 'in', res = 300)

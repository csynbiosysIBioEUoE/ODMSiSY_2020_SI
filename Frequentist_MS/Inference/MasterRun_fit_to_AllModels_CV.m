...
function [] = MasterRun_fit_to_AllModels_CV(resultBase, numExperiments, mdl)
...
parfor epcc_exps=1:numExperiments
    ...
    if ~ismember(m,fi)
        ...
        try
            ...
            [out] = Masterfit_to_AllModels_CV(epccOutputResultFileNameBase,epcc_exps,global_theta_guess, mdl);
        catch err
            %open file

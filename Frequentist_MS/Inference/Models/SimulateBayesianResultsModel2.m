...
Mod1 = ToggleSwitch_load_model_M2;
...
for i=1:length(Dat.Data.exp_data)
    ...
    y0 = M2_Compute_SteadyState_OverNight(inputs,mean(thetaMatrix),Dat.Data.exp_data{i}(end,:),[Dat.Data.Initial_IPTG{i} Dat.Data.Initial_aTc{i}]+1e-7);
...
save('ReultsSimulations\SimulationsBayesTrainingSetModel2.mat', 'Simulations')

mkdir('ReultsSimulations\PlotsModel2')
for j=1:10
    h = figure;
    subplot(6,1,1:2)
    hold on
    ...
    saveas(h, ['ReultsSimulations\PlotsModel2\BayesSimulationModel2_TrainingSet_',num2str(j),'.png'])
end
...
save('ReultsSimulations\SimulationsBayesValidationSetModel2.mat', 'Simulations')
...
for j=1:10
    ...
    saveas(h, ['ReultsSimulations\PlotsModel2\BayesSimulationModel2_ValidationSet_',num2str(j),'.png'])
end

function [InitialConditions]= M1vsM3_Compute_SteadyState_OverNight_ModelSelection(inputs,params,InitialExpData,Initial_u)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
newExps.exp_y0{1}=M1vsM3_compute_steady_state_Analytical_ModelSelection(params,InitialExpData,Initial_u);     

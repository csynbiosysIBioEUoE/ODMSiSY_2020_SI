function [ res ] = M2_compute_steady_state_Analytical(theta, InitialStates_AU, initial_u)
% Computes the steady state of the ToggleSwitch model 2 for the given values of

function [InitialConditions]= M3_Compute_SteadyState_OverNight(inputs,params,InitialExpData,Initial_u)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Script to simulate the initial state of the MToggleSwitch model 3 after the
...
newExps.exp_y0{1}=M3_compute_steady_state_Analytical(params,InitialExpData,Initial_u);     

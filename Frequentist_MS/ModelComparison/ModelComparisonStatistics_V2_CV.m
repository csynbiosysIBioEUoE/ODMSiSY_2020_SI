...
% Computes different model comparison statistics on Validation dataset
...
function [] = ModelComparisonStatistics_V2_CV()
...
Dat = load('E:\UNI\D_Drive\PhD\Year_1\2020_03_03_Processes2ToggleModelComparison\Scripts\1_FrequentistAnalysis\LugagneData\ValidationSetDataLugagne.mat');
...
save(['AMIGOSsimModel','1','Validation.mat'], 'simMod1')
...
save(['AMIGOStatsModel','1','Validation.mat'], 'statsM1')
...
save(['AMIGOSsimModel','2','Validation.mat'], 'simMod2')
...
save(['AMIGOStatsModel','2','Validation.mat'], 'statsM2')
...
save(['AMIGOSsimModel','3','Validation.mat'], 'simMod3')
...
save(['AMIGOStatsModel','3','Validation.mat'], 'statsM3')
...
legend('M1', 'M2', 'M3')
set(gca, 'YScale', 'log')
saveas(h, ['Plots\AIC_ValidationSet_','Final','.png'])
...
legend('M1', 'M2', 'M3')
set(gca, 'YScale', 'log')
saveas(h, ['Plots\BIC_ValidationSet_','Final','.png'])
...
legend('M1', 'M2', 'M3')
set(gca, 'YScale', 'log')
saveas(h, ['Plots\R2_ValidationSet_','Final','.png'])
...
ylabel('RMSE')
legend('M1', 'M2', 'M3')
saveas(h, ['Plots\RMSE_ValidationSet_','Final','.png'])
...
legend('M1', 'M2', 'M3')
set(gca, 'YScale', 'log')
saveas(h, ['Plots\MCP_ValidationSet_','Final','.png'])
...
legend('M1', 'M2', 'M3')
set(gca, 'YScale', 'log')
saveas(h, ['Plots\SSE_ValidationSet_','Final','.png'])

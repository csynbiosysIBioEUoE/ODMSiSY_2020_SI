...
% This script computs 2 separate cost functions as the Euclidean distance
% between RFP simulations and GFP simulations for a Multi objective
% optimisation case. 
...
function [f,g,h] = OEDModelSelectionCostMultiObject(od,inputs,results,privstruct)

...
Mod1 = ToggleSwitch_load_model_M3;
...
for i=1:length(Dat.Data.exp_data)
    ...
    y0 = M3_Compute_SteadyState_OverNight(inputs,mean(thetaMatrix),Dat.Data.exp_data{i}(end,:),[Dat.Data.Initial_IPTG{i} Dat.Data.Initial_aTc{i}]+1e-7);
...
save('ReultsSimulations\SimulationsBayesTrainingSetModel3.mat', 'Simulations')

mkdir('ReultsSimulations\PlotsModel3')
for j=1:10
    h = figure;
    subplot(6,1,1:2)
    hold on
    ...
    saveas(h, ['ReultsSimulations\PlotsModel3\BayesSimulationModel3_TrainingSet_',num2str(j),'.png'])
end



%% Simulation Model 3 Validation
...
save('ReultsSimulations\SimulationsBayesValidationSetModel3.mat', 'Simulations')
...
for j=1:10
    ...
    saveas(h, ['ReultsSimulations\PlotsModel3\BayesSimulationModel3_ValidationSet_',num2str(j),'.png'])
end

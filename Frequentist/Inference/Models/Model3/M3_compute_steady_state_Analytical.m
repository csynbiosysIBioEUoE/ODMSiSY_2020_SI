function [ res ] = M3_compute_steady_state_Analytical(theta, InitialStates_AU, initial_u)
% Computes the steady state of the MToggleSwitch model 3 for the given values of
